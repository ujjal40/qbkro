...
class TorrentDictionary(Dictionary):
    ...
    @property
    def download_limit(self, **kwargs) -> TorrentLimitsDictionary: ...
    ...
    @property
    def upload_limit(self, **kwargs) -> TorrentLimitsDictionary: ...
...
class TorrentFilesList(List):
    def __init__(self, list_entries: Iterable[Text], client: Client = None) -> None: ...
